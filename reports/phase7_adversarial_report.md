...
| 10a | internal-port attacks (categories 2/3/5/6) are captured in an audit trail | FIXED this phase (audit middleware attached to the internal app) | internal audit log has 38 entries | no | yes |
